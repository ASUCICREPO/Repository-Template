...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from workflow files. Use `readFile` with the path pattern: `.kiro/powers/ai-dlc-methodology/workflows/{phase}/{filename}.md`

**Path Resolution**: All file references in this document (e.g., `inception/workspace-detection.md`, `common/content-validation.md`) are relative to `.kiro/powers/ai-dlc-methodology/workflows/`. When a step says "Load all steps from `inception/workspace-detection.md`", use `readFile` with path `.kiro/powers/ai-dlc-methodology/workflows/inception/workspace-detection.md`.

**Common Rules**: ALWAYS load common rules at workflow start:
- Load `.kiro/powers/ai-dlc-methodology/workflows/common/process-overview.md` for workflow overview
- Load `.kiro/powers/ai-dlc-methodology/workflows/common/session-continuity.md` for session resumption guidance
- Load `.kiro/powers/ai-dlc-methodology/workflows/common/content-validation.md` for content validation requirements
- Load `.kiro/powers/ai-dlc-methodology/workflows/common/question-format-guide.md` for question formatting rules
...
1. Load the welcome message from `.kiro/powers/ai-dlc-methodology/workflows/common/welcome-message.md`
